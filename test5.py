...
def get_latest_ami(ami_name, region):
    ...
    try:
        ...
        if images:
            ...
            return f"{latest_ami_info['ImageId']}"
        else:
            return "Error: AMI might be too old or unable to get correct pattern."
    except Exception as e:
        return f"Error: Unable to get the latest AMI information. {str(e)}"
...
def get_instance_details():
    ...
    for reservation in instances['Reservations']:
        for instance in reservation['Instances']:
            ...
            latest_ami = get_latest_ami(ami_name, region)
            ...
            add_to_csv("Latest AMI", latest_ami , row, data_store)
